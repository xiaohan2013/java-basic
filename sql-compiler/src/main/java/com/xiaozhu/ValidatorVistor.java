...
import com.xiaozhu.algebra.*;
import com.xiaozhu.gen.CalculatorBaseVisitor;
import com.xiaozhu.gen.CalculatorParser;

import java.util.List;
import java.util.Map;

public class ValidatorVistor extends CalculatorBaseVisitor<AlgebraNode> {
    private final Map<String, DataType> variableTypes;

    public ValidatorVistor(Map<String, DataType> variableTypes) {
